...
categories: [preprint]
tags: [Autonomous Driving, Dynamic 3D, Gaussian Splatting, Diffusion Model]
language: en
cover:
...
## Multi-cameras
{{< figure src="images/styledSG-3views.gif" alt="multicams" width="100%" >}}

## Real application For urban reonstruction

A real application example for urban reonstruction in Shunyi.

<video controls loop muted playsinline style="width: 100%; height: auto; border-radius: 4px;">
    <source src="images/styledstreets_shunyi.mp4" type="video/mp4">
</video>

<p><a href="images/styledstreets_shunyi.mp4" download>Download MP4</a></p>
